...
Silk.NET is a high-speed, advanced library, providing bindings to popular low-level APIs such as DirectX. Use Silk.NET to add cross-platform 3D graphics, audio, compute and haptics to your C# application.
...
- **Up-to-date**: We've built Silk.NET around the latest versions of DirectX. This means that Silk.NET includes DirectX 12 and more.
...
- Run build.sh, build.cmd, build.ps1, or `nuke build`.
