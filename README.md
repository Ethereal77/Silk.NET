...
- **Up-to-date**: We've built Silk.NET around the latest versions of the Khronos specifications. This means that Silk.NET includes Vulkan 1.2 (and its **NVIDIA and KHR ray-tracing** extensions), and more.
